...
module Import
  class PeopleImporter
    ...
    attr_reader :path, :output, :errors, :invalid_emails, :processed_rows_count
    ...
    def contact_role_group
      @contact_role_group ||= Group::ExterneKontakte.
        find_or_create_by!(name: 'Navision Import', parent_id: Group::SacCas.first!.id)
    end
