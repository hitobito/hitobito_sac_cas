...
module Export::Tabular::People
  class AlpsRecipients < Export::Tabular::Base
    ...
    attr_reader :reference_date, :abonnent_group_langs, :full, :lang

    def initialize(scope, reference_date, abonnent_group_langs, full: false, lang: nil)
      super(scope)
    ...
    def row_for(entry, format = nil)
      row_class.new(entry, reference_date, abonnent_group_langs, lang: lang)
    end
  end
end
