...
module Export::Tabular::People
  class AlpsRecipientsScope
    SAC_MITGLIEDER = Group::SektionsMitglieder::Mitglied
    ...
    def germany
      base_scope
        .where(language_condition(:de, abonnent_group_ids.values))
    ...
    def new_entries_condition(lang, abo_group_ids)
      ...
      new_mitglieder_ids = eintritte_scope(SAC_MITGLIEDER).pluck(:person_id)
      new_abonnenten_ids = eintritte_scope(*MAGAZIN_ABONNENTEN)
