...
module SacImports
  module Events
    class EventEntry
      ...
      ATTRS_TRANSLATED = [:name, :description, :application_conditions, :brief_description, :specialities, :similar_tours, :program]
      ATTRS_REGULAR = [:number, :contact_id, :location, :minimum_age, :maximum_age, :minimum_participants, :maximum_participants, :ideal_class_size, :maximum_class_size, :training_days, :season, :accommodation, :meals, :language, :start_point_of_time, :application_opening_at, :application_closing_at, :signature_confirmation_text, :price_member, :price_regular, :price_subsidized, :price_js_active_member, :price_js_active_regular, :price_js_passive_member, :price_js_passive_regular, :link_participants, :link_leaders, :link_survey, :book_discount_code]
      ATTRS_BOOLEAN = [:reserve_accommodation, :globally_visible, :annual, :external_applications, :participations_visible, :priorization, :automatic_assignment, :signature, :signature_confirmation, :applications_cancelable, :display_booking_info]
      ...
      def event
        @event ||= Event::Course.find_or_initialize_by(number: row.number, state: row.state)
      end
