...
class Event::TechnicalRequirement < ActiveRecord::Base
  ...
  belongs_to :parent, optional: true, class_name: "Event::TechnicalRequirement"
  has_many :children,
