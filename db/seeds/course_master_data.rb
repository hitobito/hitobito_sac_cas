...
def seed_event_kind_categories # rubocop:todo Metrics/AbcSize # rubocop:todo Metrics/MethodLength
  ...
  Event::KindCategory.seed_once(:order,
    {order: 100, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A0100")},
    {order: 300, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A0300")},
    {order: 500, cost_center_id: cost_centers.fetch("2100025"),
     cost_unit_id: cost_units.fetch("A0500")},
    {order: 700, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A0700")},
    {order: 900, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A0900")},
    {order: 1100, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A1100")},
    {order: 1300, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A1300")},
    {order: 1500, cost_center_id: cost_centers.fetch("2100025"),
     cost_unit_id: cost_units.fetch("A1500")},
    {order: 2000, cost_center_id: cost_centers.fetch("2100025"),
     cost_unit_id: cost_units.fetch("A2000")},
    {order: 2300, cost_center_id: cost_centers.fetch("2100024"),
     cost_unit_id: cost_units.fetch("A2300")},
    {order: 2500, cost_center_id: cost_centers.fetch("2100024"),
     cost_unit_id: cost_units.fetch("A2500")},
    {order: 5000, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5000")},
    {order: 5200, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5200")},
    {order: 5300, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5300")},
    {order: 5400, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5400")},
    {order: 5500, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5500")},
    {order: 5600, cost_center_id: cost_centers.fetch("2100022"),
     cost_unit_id: cost_units.fetch("A5600")},
    {order: 6000, cost_center_id: cost_centers.fetch("2100025"),
     cost_unit_id: cost_units.fetch("A6000")},
    {order: 6500, cost_center_id: cost_centers.fetch("2100025"),
     cost_unit_id: cost_units.fetch("A6500")},
    {order: 6800, cost_center_id: cost_centers.fetch("2100024"),
     cost_unit_id: cost_units.fetch("A6800")},
    {order: 7000, cost_center_id: cost_centers.fetch("2100024"),
     cost_unit_id: cost_units.fetch("A7000")},
    {order: 7200, cost_center_id: cost_centers.fetch("2100040"),
     cost_unit_id: cost_units.fetch("A7200")},
    {order: 7300, cost_center_id: cost_centers.fetch("2100040"),
     cost_unit_id: cost_units.fetch("A7300")},
    {order: 7400, cost_center_id: cost_centers.fetch("3200310"),
     cost_unit_id: cost_units.fetch("A7400")},
    {order: 8000, cost_center_id: cost_centers.fetch("2100023"),
     cost_unit_id: cost_units.fetch("A8000")},
    {order: 8500, cost_center_id: cost_centers.fetch("2100023"),
     cost_unit_id: cost_units.fetch("A8500")},
    {order: 9000, cost_center_id: cost_centers.fetch("2100027"),
     cost_unit_id: cost_units.fetch("A9000")},
    {order: 9100, cost_center_id: cost_centers.fetch("2100001"),
     cost_unit_id: cost_units.fetch("A9100")},
    {order: 9500, cost_center_id: cost_centers.fetch("2100028"),
     cost_unit_id: cost_units.fetch("A9500")},
    {order: 9999, cost_center_id: cost_centers.fetch("10000"),
...
def seed_course_compensation_categories # rubocop:todo Metrics/AbcSize # rubocop:todo Metrics/MethodLength
  CourseCompensationCategory.seed_once(:short_name,
    ...
    {short_name: "TP-SKI-TECHNIK/PASS", kind: :day,
...
def seed_course_compensation_rates # rubocop:todo Metrics/AbcSize # rubocop:todo Metrics/MethodLength
  ...
  CourseCompensationRate.seed_once(:course_compensation_category_id,
    {course_compensation_category_id: categories.fetch("HO-0001"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0002"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 440.00, rate_assistant_leader: 440.00},
    {course_compensation_category_id: categories.fetch("HO-0003"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0004"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0007"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0008"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0009"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0011"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HO-0012"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 530.00, rate_assistant_leader: 530.00},
    {course_compensation_category_id: categories.fetch("HON-KAT-I"), valid_from: "2024-01-01",
     valid_to: nil, rate_leader: 550.00, rate_assistant_leader: 540.00},
    {course_compensation_category_id: categories.fetch("HON-KAT-II"), valid_from: "2024-01-01",
     valid_to: nil, rate_leader: 470.00, rate_assistant_leader: 460.00},
    {course_compensation_category_id: categories.fetch("HON-KAT-III"), valid_from: "2024-01-01",
     valid_to: nil, rate_leader: 570.00, rate_assistant_leader: 540.00},
    {course_compensation_category_id: categories.fetch("HON-KAT-IV"), valid_from: "2024-01-01",
     valid_to: nil, rate_leader: 600.00, rate_assistant_leader: 560.00},
    {course_compensation_category_id: categories.fetch("HON-KAT-V"), valid_from: "2024-01-01",
     valid_to: nil, rate_leader: 550.00, rate_assistant_leader: 540.00},
    {course_compensation_category_id: categories.fetch("KP-ADMIN-KAT I-IV"),
     valid_from: "2024-01-01", valid_to: nil, rate_leader: 150.00, rate_assistant_leader: 0.00},
    {course_compensation_category_id: categories.fetch("KP-REISE/MATERIAL"),
     valid_from: "2024-01-01", valid_to: nil, rate_leader: 130.00, rate_assistant_leader: 130.00},
    {course_compensation_category_id: categories.fetch("KV-0001"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 50.00, rate_assistant_leader: 0.00},
    {course_compensation_category_id: categories.fetch("SPD-0001"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 0.00, rate_assistant_leader: 0.00},
    {course_compensation_category_id: categories.fetch("SPÖ-0001"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 0.00, rate_assistant_leader: 0.00},
    {course_compensation_category_id: categories.fetch("SPP-0001"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 0.70, rate_assistant_leader: 0.70},
    {course_compensation_category_id: categories.fetch("TP-SKI-TECHNIK/PASS"),
     valid_from: "2024-01-01", valid_to: nil, rate_leader: 60.00, rate_assistant_leader: 60.00},
    {course_compensation_category_id: categories.fetch("UB-HUETTE"), valid_from: "2024-01-01",
     valid_to: "2024-12-31", rate_leader: 0.00, rate_assistant_leader: 0.00})
end
# rubocop:enable Metrics/MethodLength
