...
{ key: Event::ParticipationMailer::CONTENT_REJECTED_PARTICIPATION, # 'event_participation_rejected`
  ...
  { key: Qualification::ExpirationMailer::REMINDER_NEXT_TWO_YEARS }
)
...
CustomContent::Translation.seed_once(:custom_content_id, :locale,
  ...
  { custom_content_id: CustomContent.get(Qualification::ExpirationMailer::REMINDER_NEXT_TWO_YEARS).id,
    locale: 'de',
