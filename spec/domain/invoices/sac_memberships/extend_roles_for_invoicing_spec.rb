  ...
  describe "convert roles to youth" do
    ...
    context "dissolving household" do
      ...
      context "with multiple turned youth members" do
        let!(:second_person_turned_youth) { Fabricate(:person_with_role, group: bluemlisalp_mitglieder, role: "Mitglied", beitragskategorie: :adult, email: "sister@hitobito.example.com", confirmed_at: Time.current, birthday: reference_date - 14.years) }
