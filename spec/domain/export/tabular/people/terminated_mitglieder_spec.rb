...
describe Export::Tabular::People::TerminatedMitglieder do
  ...
  describe "#people_scope" do
    ...
    it "testing most common cases" do
      ...
      zusatzsektions_austritt = create_role("Mitglied", matterhorn, start_on: "10.7.2024", end_on: "31.12.2024").person
      create_role("MitgliedZusatzsektion", start_on: "10.7.2024", end_on: "31.12.2024", person: zusatzsektions_austritt)

      stammsektions_wechsel = create_role("Mitglied", matterhorn, start_on: "3.2.2000", end_on: "31.12.2024").person
      create_role("Mitglied", start_on: "1.1.2025", person: stammsektions_wechsel)
      ...
      ehrenmitglied = create_role("Mitglied", start_on: "1.1.2025", end_on: "31.12.2025").person
      create_role("Ehrenmitglied", start_on: "1.1.2025", end_on: "31.12.2025", person: ehrenmitglied)
