...
describe Export::Pdf::Participations::ParticipantList do
  ...
  before do
    ...
    Fabricate(:phone_number, contactable: people(:familienmitglied), label: :mobile, number: "+41 77 360 75 63")
    Fabricate(:phone_number, contactable: people(:mitglied), label: :landline, number: "+41 77 484 21 96")
  end
