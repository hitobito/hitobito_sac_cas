...
describe Export::Pdf::Participations::KeyDataSheet do
  ...
  let(:texts) {
    [
      ...
      [195, 232, "Bitte Klassenleiter*in und Unterkunft informieren"],
      [75, 211, "Ideale Klassengrösse"],
      [75, 190, "Maximale Klassengrösse"],
      [75, 169, "Klassenleiter*in"],
      [195, 170,
        "Leitung verpflichtet gem. max. Teilnehmerzahl im Voraus die Klassenleiter*in - bitte im"],
      [195, 159,
