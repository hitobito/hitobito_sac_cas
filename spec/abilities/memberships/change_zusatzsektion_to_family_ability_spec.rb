...
describe Memberships::ChangeZusatzsektionToFamilyAbility do
  ...
  let(:zusatzsektion_role) do
    p = Fabricate(Group::SektionsMitglieder::Mitglied.sti_name,
  ...
  context "as backoffice" do
    ...
    it "may manage" do
      expect(ability).to be_able_to(:manage,
        Memberships::ChangeZusatzsektionToFamily.new(zusatzsektion_role))
    end
  end
  ...
  context "as mitglied" do
    ...
    it "may not manage" do
      expect(ability).to_not be_able_to(:manage,
        Memberships::ChangeZusatzsektionToFamily.new(zusatzsektion_role))
    end
  end
end
