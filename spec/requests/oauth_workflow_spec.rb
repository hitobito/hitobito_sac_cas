  ...
  describe "redirection after oauth sign in" do
    ...
    context "person with roles" do
      ...
      it "redirects to oauth authorization path without prompt" do
        ...
        oauth_params = {client_id: @app.uid, client_secret: @app.secret,
                        # rubocop:todo Layout/LineLength
                        redirect_uri: redirect_uri, response_type: :code, scope: :openid, prompt: :login}
        # rubocop:enable Layout/LineLength
        get oauth_authorization_path, params: oauth_params
