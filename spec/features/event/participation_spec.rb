  ...
  context "as admin" do
    ...
    context "event questions" do
      ...
      it "orders event questions alphabetically on show page" do
        visit group_event_participation_path(group_id: event.groups.first.id, event_id: event.id,
          id: participation.id)
      ...
      it "orders event questions alphabetically on edit page" do
        visit edit_group_event_participation_path(group_id: event.groups.first.id,
