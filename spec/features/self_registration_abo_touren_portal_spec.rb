...
describe :self_registration do
  ...
  def complete_main_person_form
    ...
    fill_in 'self_registration_abo_touren_portal_main_person_attributes_street', with: 'Musterplatz'
    fill_in 'self_registration_abo_touren_portal_main_person_attributes_housenumber', with: '42'
